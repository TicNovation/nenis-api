...
class PlanController extends Controller
{
    ...
    public function crear(Request $request)
    {
        $validate = Validator::make($request->all(), [
            ...
            'max_items_negocio' => 'required|integer|min:0',
            'max_sucursales_negocio' => 'required|integer|min:0',
            ...
            'max_ia_consultas' => 'required|integer|min:0',
            'incluye_ia_negocios' => 'required|boolean',
